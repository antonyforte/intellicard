      ...
      <div class="text-area-containers">
        ...
        <div class="ia-response-container">
          ...
          <div class="ia-buttons">
            ...
            <button id="reload-response" class="btn btn-primary update">
              <img src="{{ asset('icons/reload.png') }}" alt="reload">
            </button>

            <form id="send-response-form" action="{{ route('cardai.store') }}" method="POST" style="display:inline;">
              @csrf
